---
title: "Go语言变量的初始化 | Go语言教程"
source: "https://go.mosong.cc/tutorial/view_10.html"
author:
published:
created: 2026-04-01
...
正如上一节《 [Go语言变量声明](https://go.mosong.cc/tutorial/view_9.html) 》中提到的 [Go语言](https://go.mosong.cc/) 在声明变量时，自动对变量对应的内存区域进行初始化操作。每个变量会初始化其类型的默认值，例如：
