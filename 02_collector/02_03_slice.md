---
title: "Go语言切片 | Go语言教程"
source: "https://go.mosong.cc/tutorial/view_27.html"
author:
published:
created: 2026-04-14
...
![img](https://go.mosong.cc/assets/66cae8bb85767f5543ee00cd.B5BbTQTa.png)
...
其中 a 是一个拥有 3 个整型元素的数组，被初始化为数值 1 到 3，使用 a\[1:2\] 可以生成一个新的切片，代码运行结果如下：\[1 2 3\] \[2\]
...
a 是一个拥有 3 个元素的切片，将 a 切片使用 a\[:\] 进行操作后，得到的切片与 a 切片一致，代码输出如下：\[1 2 3\]
...
切片是动态结构，只能与 nil 判定相等，不能互相判定相等。声明新的切片后，可以使用 [append()](https://go.mosong.cc/tutorial/view_28.html) 函数向切片中添加元素。
